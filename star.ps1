...
$null = New-Module starship {
    ...
    function global:prompt {
        ...
        # Invoke Starship
        $promptText = Invoke-Native -Executable 'C:\Users\aoran\scoop\apps\starship\current\starship.exe' -Arguments $arguments
    ...
    Set-PSReadLineOption -ContinuationPrompt (
        Invoke-Native -Executable 'C:\Users\aoran\scoop\apps\starship\current\starship.exe' -Arguments @(
            "prompt",
            "--continuation"
        )
    )
